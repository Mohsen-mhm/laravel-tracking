    ...
    <div class="bg-white shadow-md rounded-lg p-6 dark:bg-gray-800">
        <div class="p-4">
            ...
            <div class="mb-4 flex justify-between items-center">
                <form action="{{ route('request.logs') }}" method="GET" class="flex gap-2">
                    <input type="text"
                           ...
                           class="px-3 py-2 text-sm border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                    <button type="submit"
                ...
                <button id="deleteSelected"
                        disabled
                        class="px-3 py-2 text-sm bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed">
                    Delete Selected
                </button>
            </div>
            ...
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                <form id="multiDeleteForm" action="{{ route('request.logs.destroy-multiple') }}" method="POST">
                    @csrf
                    @method('DELETE')
                            ...
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                <td class="px-6 py-4">
                                    <input type="checkbox"
                                           name="ids[]"
                                           value="{{ $log->id }}"
                                           class="log-checkbox rounded dark:bg-gray-700 dark:border-gray-600">
                                </td>
                                <th scope="row"
                                ...
                                <td class="px-6 py-4" x-data="{ showBody: false, showHeaders: false }">
                                    <div class="flex space-x-2 relative z-10">
                                        ...
                                        <form action="{{ route('request.logs.destroy', $log) }}"
                                              method="POST"
                                              class="inline-block">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit"
                                                    class="text-red-600 dark:text-red-500 transition hover:text-red-700 dark:hover:text-red-400"
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        if (selectAll && checkboxes.length > 0 && deleteSelected && multiDeleteForm) {
